...
export default defineConfig({
  schema: [
    ...
    "./src/schema/source-evidence-content.ts",
    "./src/schema/source-transcript.ts",
    "./src/schema/transcript-acquisition-job.ts",
